            ...
            <div class="header-nav">
                <?php echo Nav::widget([
                    ...
                    'items' => [
                        ...
                        ['label' => Yii::t('frontend', 'My Classes'), 'url' => ['/students-class/classes-index']],
                        ...
                        ['label' => Yii::t('frontend', 'Logout'),'url' => ['/user/sign-in/logout'],'linkOptions' => ['data-method' => 'post'], 'visible'=> !Yii::$app->user->isGuest],
