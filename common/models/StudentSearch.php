...
class StudentSearch extends User
{
    ...
    {
        $studentIds = Yii::$app->authManager->getUserIdsByRole('student');

        $query = User::find();

        //$query->joinWith(['rbac_auth_assignment.user_id']);
        ...
        $query->andFilterWhere(['like', 'username', $this->username])
            ...
            ->andFilterWhere(['in', 'id', $studentIds]);


            //->addFilterWhere('=', 'rbac_auth_assignment.item_name', 'student' );
