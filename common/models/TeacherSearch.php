...
/**
 * TeacherSearch represents the model behind the search form about `common\models\User`.
 */
class TeacherSearch extends User
{
    ...
    public function search($params)
    {
        ...
        $teacherIds = Yii::$app->authManager->getUserIdsByRole('teacher');
        ...
        $query->andFilterWhere(['like', 'username', $this->username])
            ...
            ->andFilterWhere(['in', 'id', $teacherIds]);
